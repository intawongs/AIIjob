...
# ==========================================
# 3. SIDEBAR (เพิ่มระบบ ลบพนักงาน/โปรเจกต์)
# ==========================================
with st.sidebar:
    ...
    with st.expander("📂 จัดการ Baseline โปรเจกต์"):
        ...
        if not master_projs.empty:
            ...
            if st.button("🗑️ ลบ Baseline นี้", type="secondary"):
                sh = connect_gsheet()
...
# --- TAB 1: Gantt Chart (Isolation & Grouped Alert) ---
with tabs[1]:
